...
# Load the DNN model
model = cv2.dnn.readNet(model='models/frozen_inference_graph.pb', config='models/ssd_mobilenet_v2_coco_2018_03_29.pbtxt', framework='TensorFlow')
...
while cap.isOpened():
    ...
    # Make forward pass in the model
